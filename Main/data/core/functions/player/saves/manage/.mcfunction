...
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Profiles[1] run tellraw @s {"text":"[Save 0]","clickEvent":{"action":"run_command","value":"/scoreboard players set $Profile Temporary 1"}}
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Profiles[2] run tellraw @s {"text":"[Save 0]","clickEvent":{"action":"run_command","value":"/scoreboard players set $Profile Temporary 2"}}
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Profiles[3] run tellraw @s {"text":"[Save 0]","clickEvent":{"action":"run_command","value":"/scoreboard players set $Profile Temporary 3"}}
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Profiles[4] run tellraw @s {"text":"[Save 0]","clickEvent":{"action":"run_command","value":"/scoreboard players set $Profile Temporary 4"}}
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Profiles[5] run tellraw @s {"text":"[Save 0]","clickEvent":{"action":"run_command","value":"/scoreboard players set $Profile Temporary 5"}}
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Profiles[6] run tellraw @s {"text":"[Save 0]","clickEvent":{"action":"run_command","value":"/scoreboard players set $Profile Temporary 6"}}
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Profiles[7] run tellraw @s {"text":"[Save 0]","clickEvent":{"action":"run_command","value":"/scoreboard players set $Profile Temporary 7"}}
execute if data storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Profiles[8] run tellraw @s {"text":"[Save 0]","clickEvent":{"action":"run_command","value":"/scoreboard players set $Profile Temporary 8"}}
tellraw @s {"text":"================","color":"gold","strikethrough":true}
...
function core:player/saves/manage/view
...
execute as @s[tag=Delete] run function core:player/saves/manage/delete
