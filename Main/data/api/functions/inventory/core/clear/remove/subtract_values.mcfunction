...
# 個数取得
    execute store result score $Count Temporary run data get storage api: NewInv[-1].Count
# アイテムの新しい個数をセット
    ...
    execute store result storage api: NewInv[-1].Count byte 1 run scoreboard players get $NewCount Temporary
# 目標数を減算
